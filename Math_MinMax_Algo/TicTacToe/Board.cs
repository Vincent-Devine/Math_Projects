...
namespace TicTacToe
{
	public class Board
	{
		...
		public void Draw()
		{
            ...
            Console.WriteLine("All algorithm for depth: " + depth);
            Console.WriteLine("--------------- MiniMax ----------------");
            Console.WriteLine("Number of iteration for MiniMax: " + MiniMax.GetIteration());
            Console.WriteLine("Time in miliseconds for MiniMax: " + MiniMax.GetTime());
            Console.WriteLine("--------------- NegaMax ----------------");
            Console.WriteLine("Number of iteration for NegaMax: " + NegaMax.GetIteration());
            Console.WriteLine("Time in miliseconds for NegaMax: " + NegaMax.GetTime());
            Console.WriteLine("-------------- AlphaBeta ---------------");
            Console.WriteLine("Number of iteration for AlphaBeta: " + AlphaBeta.GetIteration());
            Console.WriteLine("Time in miliseconds for AlphaBeta: " + AlphaBeta.GetTime());
            Console.WriteLine();
